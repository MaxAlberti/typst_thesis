#let titlepage(authors, title, language, date, at-dhbw, logo-left, logo-right, left-logo-height, right-logo-height, university, university-location, supervisor, heading-font, many-authors, type-of-thesis) = {
  if (many-authors) {
    v(-1em)
  }
  ...
  align(center, text(weight: "regular", font: heading-font, 2em, title))
  ...
  align(center, text(weight: "bold", font: heading-font, 1.5em, type-of-thesis))
  ...
  align(center, text(1.2em, [#if (language == "de") {
    [des Studienganges #authors.map(author => author.course-of-studies).dedup().join(" | ")]
  } else {
